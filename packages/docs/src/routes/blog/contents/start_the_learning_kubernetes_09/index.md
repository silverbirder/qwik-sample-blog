...
[一足遅れて Kubernetes を学び始める - 08. discovery&LB その 1 -](../start_the_learning_kubernetes_08/index.md)で Service についての概要を学びました。今回は下記を一気に学びます。
...
次回は[こちら](../start_the_learning_kubernetes_10/index.md)です。
