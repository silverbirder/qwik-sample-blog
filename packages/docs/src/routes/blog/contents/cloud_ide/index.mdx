...
<figure title="github-codespaces">
  <Image
    src="https://visualstudio.microsoft.com/wp-content/uploads/2020/09/codespaces-vs.png"
    width={3840}
    height={2084}
    layout="constrained"
  ...
  />
  <figcaption>
    <a href="https://github.co.jp/features/codespaces">
...
<figure title="cloud-shell-editor">
  <Image
    src="https://storage.googleapis.com/gweb-cloudblog-publish/images/Cloud_shell_editor.max-2000x2000.jpg"
    width={2000}
    height={1120}
    layout="constrained"
  ...
  />
  <figcaption>
    <a href="https://cloud.google.com/blog/ja/products/application-development/introducing-cloud-shell-editor">
      https://cloud.google.com/blog/ja/products/application-development/introducing-cloud-shell-editor
    </a>
  </figcaption>
</figure>
...
<figure title="gitpod">
  <Image
    src="https://www.gitpod.io/images/gitpod-editor.jpg"
    width={2880}
    height={1864}
    layout="constrained"
    alt="gitpod"
  />
  <figcaption>
    <a href="https://www.gitpod.io">https://www.gitpod.io</a>
  </figcaption>
</figure>
