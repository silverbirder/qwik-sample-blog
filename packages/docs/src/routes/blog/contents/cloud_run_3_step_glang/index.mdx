...
<figure title="Cloud Run Deploy">
  <Image
    src="https://japan.zdnet.com/storage/2019/04/10/2f758123dc855c1aa3533aea8d507950/190410-abrigednews-02-google-devops-with-serverless.png"
    width={1000}
    height={576}
    layout="constrained"
  ...
  />
  <figcaption>
    <a href="https://japan.zdnet.com/article/35135525/">Cloud Run Deploy</a>
  </figcaption>
</figure>
